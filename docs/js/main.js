$(document).ready(function() {
	...
	$('.filter-block__button').on('click', function() {
		if ($('.filter-block__button').hasClass('filter-block__button--active')) {
			$('.filter-block__button').removeClass('filter-block__button--active');
		}
		$(this).toggleClass('filter-block__button--active');
  });
  // активная кнопка фильтрации - конец
